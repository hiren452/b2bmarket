<?php
namespace Matrix\NoncatalogueRfq\Model\Buyervisibility;
...
class DataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    public function __construct(
        ...
        $this->meta['buyervisibility']['children'] = $this->getAttributesMeta(
    ...
    public function getData(): array
    {
        ...
        foreach ($items as $customer) {
            $result['buyervisibility'] = $customer->getData();

            $this->fileUploaderDataResolver->overrideFileUploaderData($customer, $result['buyervisibility']);

            $result['buyervisibility'] = array_diff_key(
                $result['buyervisibility'],
        ...
        if (!empty($data)) {
            $customerId = $data['buyervisibility']['entity_id'] ?? null;
    ...
    {
        $meta = [];
        $allowedAttributes = ["rfqbuyer_isvisible"];
