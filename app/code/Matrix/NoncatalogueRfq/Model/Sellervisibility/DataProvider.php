<?php
namespace Matrix\NoncatalogueRfq\Model\Sellervisibility;
...
class DataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    public function __construct(
        ...
        $this->meta['sellervisibility']['children'] = $this->getAttributesMeta(
    ...
    public function getData(): array
    {
        ...
        foreach ($items as $customer) {
            $result['sellervisibility'] = $customer->getData();

            $this->fileUploaderDataResolver->overrideFileUploaderData($customer, $result['sellervisibility']);

            $result['sellervisibility'] = array_diff_key(
                $result['sellervisibility'],
        ...
        if (!empty($data)) {
            $customerId = $data['sellervisibility']['entity_id'] ?? null;
    ...
    {
        $meta = [];
        $allowedAttributes = ["rfqseller_isvisible"];
