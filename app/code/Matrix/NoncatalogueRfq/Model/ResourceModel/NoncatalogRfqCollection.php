 ...
 */
class NoncatalogRfqCollection extends \Magento\Framework\View\Element\UiComponent\DataProvider\SearchResult
{
    /**
    ...
    public function __construct(
        ...
        $mainTable = 'matrix_noncatalog_rfq',
        $resourceModel = '\Matrix\NoncatalogueRfq\Model\ResourceModel\NoncatalogRfq'
    ) {
