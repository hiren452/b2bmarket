...
class Form extends \Magento\Backend\Block\Template
{
    ...
    public function getRfqProducts()
    {
        ...
        $collections = $this->_itemCollection->create()
                    ->addFieldToFilter('rfq_id', $this->getQuoteId())
                    ->addFieldToSelect('*');
        return $collections->getFirstItem();
    }

    public function getRfqAllProducts()
    {
        $quote_id = $this->getRequest()->getParam('quoteId');
        $collections = $this->_itemCollection->create()
                    ->addFieldToFilter('rfq_id', $this->getQuoteId())
    ...
    public function getNegotistionHistory($quote_id)
    {
    ...
    {
        $dateTimeZone = $this->timezone->date(new \DateTime($date))->format('M d Y h:i:s A');
        return $dateTimeZone;
    }
}
