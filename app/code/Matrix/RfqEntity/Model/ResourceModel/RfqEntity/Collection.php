<?php
namespace Matrix\RfqEntity\Model\ResourceModel\RfqEntity;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(\Matrix\RfqEntity\Model\RfqEntity::class, \Matrix\RfqEntity\Model\ResourceModel\RfqEntity::class);
    }
