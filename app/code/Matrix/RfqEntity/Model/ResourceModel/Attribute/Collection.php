<?php
namespace Matrix\RfqEntity\Model\ResourceModel\Attribute;
...
class Collection extends EavCollection
{
    ...
    /*protected function _initSelect()
    {
        $this->getSelect()->from(
            ...
            $this->_eavEntityFactory->create()->setType(RfqEntitySetup::ENTITY_TYPE_CODE)->getTypeId()
        )->join(
            ['additional_table' => $this->getTable(RfqEntitySetup::EAV_ENTITY_TYPE_CODE . '_eav_attribute')],
