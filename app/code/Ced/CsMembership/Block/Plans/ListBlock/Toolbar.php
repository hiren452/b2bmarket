...
/**
 * Class Toolbar (for adding toolbar in list)
 */
class Toolbar extends \Magento\Framework\View\Element\Template
{
     ...
     * @param \Ced\CsMembership\Model\Membership $catalogConfig
    ...
    public function getCurrentDirection()
    {
        ...
        $directions = ['asc', 'desc'];
        $dir = $this->_toolbarModel->getDirection() ? strtolower($this->_toolbarModel->getDirection()) : '';
