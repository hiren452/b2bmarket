...
namespace Ced\CsAuction\Model\ResourceModel\Auction\Grid;
...
class Collection extends \Magento\Framework\View\Element\UiComponent\DataProvider\SearchResult
{
    ...
    public function __construct(
        ...
        $mainTable = 'ced_auction_auctionlist',
        $resourceModel = '\Ced\Auction\Model\ResourceModel\Auction'
    ) {
